  ...
  public static void main(String args[]) {
    ...
    try {
     ...
     try{
       ...
       File food_csv = new File("food.csv");
       Scanner myReader = new Scanner(food_csv);
       String sqlStatement = "";
       while (myReader.hasNextLine()) {
        String data = myReader.nextLine();
        String[] items = data.split(",");
        sqlStatement = "INSERT INTO \"food\" (foodid, fooditem, price) VALUES(" + items[0] + ",'" + items[1] + "'," + items[2] + ");";
